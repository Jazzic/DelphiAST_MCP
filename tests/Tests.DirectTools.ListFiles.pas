...
type
  ...
  public
    ...
    // list_files tests
    [Test] procedure NoFilter_ReturnsAll6Files;
...
procedure TDirectToolsListFilesTests.NoFilter_ReturnsAll6Files;
var
  Params: TJSONObject;
  Result: TJSONValue;
  Arr: TJSONArray;
begin
  ...
  try
    ...
    try
      ...
      Assert.AreEqual(9, Arr.Count, 'Should have 9 files');
      ...
      Assert.IsTrue(ArrayContainsValue(Arr, 'CouplingDemo.pas'), 'Should contain CouplingDemo.pas');
      Assert.IsTrue(ArrayContainsValue(Arr, 'ProceduralUnit.pas'), 'Should contain ProceduralUnit.pas');
